You are running commands on Kali Linux. To compile, you can run `cd ~/esp/esp-idf/ && . ./export.sh && cd ~/桌面/Projects/CardputerCoolOS/` to activate the env first, then run `idf.py build`.
